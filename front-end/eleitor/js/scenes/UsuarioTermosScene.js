			...
			<View style={{flex: 1, backgroundColor: 'white'}}>
				...
				<ScrollView style={{flex: 1}}>
					<View style={styles.view}>
						...
						<Text>4.3. Se tomar conhecimento de qualquer utilização não autorizada da sua senha ou da sua conta, o Usuário deverá nos notificar imediatamente no endereço: <Text style={{color: 'blue', textDecorationLine: 'underline'}} onPress={() => {Linking.openURL('mailto:eleitor.app@gmail.com')}}>eleitor.app@gmail.com</Text></Text>
						<Text/>
					</View>
				</ScrollView>
			</View>
